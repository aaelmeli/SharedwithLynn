...
bashcmd = 'bash -c '; % WSL
runcmd = ['"cd /home/aaelmeli/projects/first_test/' directoryname '/' mooseforwarddirectory ' && cp  ' Output.wavefieldoutputfilename_real ' ' Output.wavefieldoutputfilename_imag ' /mnt/e/3D_SWE_MOOSE/matlab_and_moose_parallel_backup/' directoryname '/ > NULL "'];
