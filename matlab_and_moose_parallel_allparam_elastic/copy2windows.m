...
runcmd = ['"cd /home/aaelmeli/projects/first_test/' directoryname '/' outdirectoryname ' && cp ' num2str(Output.wavefieldoutputfilename_real) ' ' num2str(Output.wavefieldoutputfilename_imag) ' /mnt/e/3D_SWE_MOOSE/matlab_and_moose_parallel_allparam_elastic/' directoryname '/> NULL "'];
