...
velocity1(ind2)=log10(80e3);
velocity1(ind)=log10(45e3);
velocity1(ind1)=log10(15e3);


velocity1= smoothdata(velocity1,2,'gaussian',4);
velocity1= smoothdata(velocity1,1,'gaussian',4);
...
% write the storage material file 
    ...
    storage_filename='E:\3D_SWE_MOOSE\matlab_and_moose_parallel_allparam_elastic\';
    loss_filename='E:\3D_SWE_MOOSE\matlab_and_moose_parallel_allparam_elastic\';
    storage_filename=append(storage_filename,directoryname,'\','storage_dist.txt');
    loss_filename=append(loss_filename,directoryname,'\','viscosity_dist.txt');

    storage_derivative_filename='E:\3D_SWE_MOOSE\matlab_and_moose_parallel_allparam_elastic\';
    storage_derivative_filename=append(storage_derivative_filename,directoryname,'\','storage_derivativer_dist.txt');
    
    loss_derivative_filename='E:\3D_SWE_MOOSE\matlab_and_moose_parallel_allparam_elastic\';
    loss_derivative_filename=append(loss_derivative_filename,directoryname,'\','viscosity_derivativer_dist.txt');
