...
runcmd = ['"cd /home/aaelmeli/projects/first_test/' num2str(directoryname) ' && cp ' num2str(filename) ' /mnt/e/3D_SWE_MOOSE/matlab_and_moose_parallel_allparam_elastic > NULL "'];
