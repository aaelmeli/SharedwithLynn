...
%   param2=params0; %in case only inverting for eta
  param2=Inputs.params02; %in case only inverting for E and fix eta-check
%   param1=Inputs.params01; %in case only inverting for eta and fix E-check
% param2=params0; %in case only inverting for eta
...
% write the storage material file 
    ...
    storage_filename='E:\3D_SWE_MOOSE\matlab_and_moose_parallel_allparam_viscosity\';
    loss_filename='E:\3D_SWE_MOOSE\matlab_and_moose_parallel_allparam_viscosity\';
    ...
    storage_derivative_filename='E:\3D_SWE_MOOSE\matlab_and_moose_parallel_allparam_viscosity\';
    storage_derivative_filename=append(storage_derivative_filename,directoryname,'\',Inputs.materialderivativefilename(1));
    
    loss_derivative_filename='E:\3D_SWE_MOOSE\matlab_and_moose_parallel_allparam_viscosity\';
