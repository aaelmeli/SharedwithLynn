...
moosegradientdirectory='grad_computation_elastic_waves';
runcmd = ['"cd /home/aaelmeli/projects/first_test/' directoryname '/' moosegradientdirectory ' && cp  _gradient_0002.csv /mnt/e/3D_SWE_MOOSE/matlab_and_moose_parallel_allparam_viscosity/' directoryname ' > NULL "'];
...
filename=['\\wsl$\Ubuntu-20.04\home\aaelmeli\projects\first_test\' directoryname '\' moosegradientdirectory '\_gradient_0002.csv'];
