...
runcmd = ['" cd  /home/aaelmeli/projects/first_test/' directoryname '"'];
...
runcmd = ['" cd  /home/aaelmeli/projects/first_test/' directoryname ' && /home/aaelmeli/mambaforge3/envs/moose/bin/mpiexec -n 2 ./first_test-opt  -i  ' num2str(filename) ' freq=' num2str(frequncy) ' --n-threads=' num2str(nthreads) '  > NULL "'];
% runcmd = ['" dos2unix -n ' num2str(filename) ' ' num2str(filename) '> NULL "'];% converts the ASCII file from DOS format to UNIX format
