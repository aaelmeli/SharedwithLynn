...
params=params0; %comment this if you want to limit the inversion to inclusion window
...
% write the storage material file 
    fileID1=fopen('E:\3D_SWE_MOOSE\matlab_and_moose\elastic_waves_inversion\youngs_modulus_dist.txt','wt'); %TODO: the name of the file needed to be dynamic
    fileID2=fopen('E:\3D_SWE_MOOSE\matlab_and_moose\elastic_waves_inversion\loss_modulus_dist.txt','wt'); %TODO: the name of the file needed to be dynamic
    fprintf(fileID1,'%s\n\n','AXIS X');
    fprintf(fileID2,'%s\n\n','AXIS X');
    nx=length(xcoord);
    for i=1:nx
