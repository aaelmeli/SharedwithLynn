...
moosegradientdirectory='grad_computation_viscoacoustics_waves';
runcmd = ['"cd /home/aaelmeli/projects/first_test/' directoryname '/' moosegradientdirectory ' && cp  _gradient1_0002.csv /mnt/e/3D_SWE_MOOSE/matlab_and_moose_parallel_allparam_viscoacoustics_bothParams/' directoryname ' && cp  _gradient2_0002.csv /mnt/e/3D_SWE_MOOSE/matlab_and_moose_parallel_allparam_viscoacoustics_bothParams/' directoryname ' > NULL "'];
